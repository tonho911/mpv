...
#install sysctl
wget -O /etc/sysctl.conf "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/config/sysctl.conf"
...
#install benchmark
wget -O /usr/bin/bench "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/bench.sh" && chmod +x /usr/bin/bench
...
#install subs
wget -O /opt/marzban/index.html "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/config/index.html"

#install env
wget -O /opt/marzban/.env "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/config/env"

#install compose
wget -O /opt/marzban/docker-compose.yml "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/config/docker-compose.yml"
...
cd /usr/bin
#List Trojan
wget -O addtrws "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addtrws" && chmod +x addtrws
wget -O addtrhu "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addtrhu" && chmod +x addtrhu
wget -O addtrgrpc "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addtrgrpc" && chmod +x addtrgrpc
wget -O addtrojan "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addtrojan" && chmod +x addtrojan
#Lits VMess
wget -O addvmws "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvmws" && chmod +x addvmws
wget -O addvmhu "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvmhu" && chmod +x addvmhu
wget -O addvmgrpc "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvmgrpc" && chmod +x addvmgrpc
wget -O addvmess "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvmess" && chmod +x addvmess
#List VLess
wget -O addvlws "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvlws" && chmod +x addvlws
wget -O addvlhu "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvlhu" && chmod +x addvlhu
wget -O addvlgrpc "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvlgrpc" && chmod +x addvlgrpc
wget -O addvless "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addvless" && chmod +x addvless
#List ShadowSocks
wget -O addshadow "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addshadow" && chmod +x addshadow
wget -O addsso "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addsso" && chmod +x addsso
wget -O addssws "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addssws" && chmod +x addssws
wget -O addsshu "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addsshu" && chmod +x addsshu
wget -O addssgrpc "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addssgrpc" && chmod +x addssgrpc
#Additional
wget -O status "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/status" && chmod +x status
wget -O addtrial "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/addtrial" && chmod +x addtrial
wget -O menu "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/menu" && chmod +x menu
wget -O ceklogin "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/ceklogin" && chmod +x ceklogin
wget -O hapus "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/hapus" && chmod +x hapus
wget -O renew "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/renew" && chmod +x renew
wget -O resetusage "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/resetusage" && chmod +x resetusage
wget -O buat_token "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/buat_token" && chmod +x buat_token
wget -O cekservice "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/cekservice" && chmod +x cekservice
wget -O ram "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/ram" && chmod +x ram
wget -O menu-backup "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/menu-backup" && chmod +x menu-backup
wget -O menu-reboot "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/menu-reboot" && chmod +x menu-reboot
wget -O menu-akun "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/menu-akun" && chmod +x menu-akun
wget -O backup "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/backup" && chmod +x backup
wget -O clearlog "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/clearlog" && chmod +x clearlog
wget -O ceklog "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/ceklog" && chmod +x ceklog
wget -O cekerror "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/cekerror" && chmod +x cekerror
wget -O ceknginx "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/ceknginx" && chmod +x ceknginx
wget -O expired "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/expired" && chmod +x expired
wget -O setlimit "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/setlimit" && chmod +x setlimit
wget -O autokill "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/autokill" && chmod +x autokill
wget -O fix-ssl "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/fix-ssl.sh" && chmod +x fix-ssl
wget -O ganticore "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/ganticore" && chmod +x ganticore
cd

#Install reboot dan expired otomatis
wget -O /usr/bin/reboot_otomatis "https://raw.githubusercontent.com/cs-69/crot/refs/heads/node/command/reboot_otomatis.sh";
